...
import { FaHome, } from "react-icons/fa"; // Importa íconos específicos
interface NavItem {
  label: string;
  page: string;
  icon?: IconType; // Campo opcional para íconos
}
...
const NAV_ITEMS: Array<NavItem> = [
  {
    label: "Home",
    page: "home",
    icon: FaHome, // Asigna el ícono de casa a Home
  },
  {
    label: "About",
    page: "about",
            ...
            <div className='items-center justify-center space-y-8 md:flex md:space-x-6 md:space-y-0'>
              ...
              {currentTheme === 'dark' ? (
                ...
                <button
                  ...
                  className='bg-slate-100 p-2 rounded-xl 'color='black'>
                  <RiMoonFill size={25} />
                </button>
              )}
            </div>
