...
const Home = () => {
  return (
    <section
      id='home'
      className='flex flex-col justify-center items-center  text-center sm:py-32 md:flex-row md:space-x-4 md:text-left md:my-0 animate-fadeIn animation-delay-2'>
